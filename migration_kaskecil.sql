...
-- AddForeignKey
ALTER TABLE `audit_log` ADD CONSTRAINT `AuditLog_id_user_fkey` FOREIGN KEY (`id_user`) REFERENCES `user`(`id_user`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `kas_kecil` ADD CONSTRAINT `KasKecil_id_shift_fkey` FOREIGN KEY (`id_shift`) REFERENCES `shift`(`id_shift`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `kas_kecil` ADD CONSTRAINT `KasKecil_id_user_fkey` FOREIGN KEY (`id_user`) REFERENCES `user`(`id_user`) ON DELETE RESTRICT ON UPDATE CASCADE;
